...
class unitTest extends PHPUnit_Framework_TestCase
{
	...
	//tests the imageGetter() function failure
	//where user doesn't have images uploaded
	function testImageGetterFail()
	{	
		//case 1, successful image get
		$uid ='testid';
		...
		$this->expectOutputString("<div>You do not have any images uploaded.</div>");
		imageGetter($mockedDbConnection, $uid);
	}
